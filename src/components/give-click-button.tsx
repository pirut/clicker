            ...
            <motion.div className="relative isolate" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.97 }}>
                ...
                <motion.button
                    ...
                    className="group relative h-30 w-30 overflow-hidden rounded-full border border-primary/45 sm:h-36 sm:w-36 md:h-40 md:w-40
                        bg-[radial-gradient(circle_at_30%_25%,rgba(255,255,255,0.5)_0%,transparent_45%),radial-gradient(circle_at_70%_75%,rgba(10,18,50,0.35)_0%,transparent_50%),linear-gradient(140deg,color-mix(in_oklch,var(--primary)_78%,black)_0%,color-mix(in_oklch,var(--primary)_56%,var(--accent))_58%,color-mix(in_oklch,var(--accent)_72%,black)_100%)]
                        shadow-[0_18px_46px_-18px_color-mix(in_oklch,var(--primary)_80%,transparent),inset_0_2px_8px_rgba(255,255,255,0.35),inset_0_-8px_16px_rgba(8,12,35,0.5)]
                        transition-all duration-300 hover:shadow-[0_24px_62px_-18px_color-mix(in_oklch,var(--primary)_85%,transparent),inset_0_2px_8px_rgba(255,255,255,0.4),inset_0_-10px_16px_rgba(8,12,35,0.55)]
                        active:shadow-[0_10px_28px_-14px_color-mix(in_oklch,var(--primary)_75%,transparent),inset_0_5px_10px_rgba(8,12,35,0.55)] disabled:cursor-not-allowed disabled:opacity-75"
                >
                    ...
                    <span className="relative z-10 flex h-full flex-col items-center justify-center gap-1 text-primary-foreground drop-shadow-[0_2px_8px_rgba(6,10,30,0.6)]">
