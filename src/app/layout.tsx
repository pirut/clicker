...
import { ClickStatsProvider } from "@/components/click-stats-provider";
...
export const viewport: Viewport = {
    ...
    maximumScale: 5,
    themeColor: [
        { media: "(prefers-color-scheme: light)", color: "#c4a67e" },
        { media: "(prefers-color-scheme: dark)", color: "#342a1f" },
    ],
};
